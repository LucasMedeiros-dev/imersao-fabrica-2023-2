...
SECRET_KEY = 'django-insecure-m)%p0run!n&wn-lsx=)r&(butic594j#u(@^-jyuk(ikm6qv!j'
...
# E que seu nome de usuario seja root e senha admin IMPORTANTE USAR APENAS PARA AMBIENTE DE DEV
# DATABASES = {
#     'default': {
